...
void Transform3D::isometricProjection() {
	...
	IsometricProjectionMatrix[0][0] = 1/sqrt(2);    IsometricProjectionMatrix[0][1] = 0;			IsometricProjectionMatrix[0][2] = 1*(-1)/sqrt(2);        IsometricProjectionMatrix[0][3] = 0;
	IsometricProjectionMatrix[1][0] = 1/sqrt(6);    IsometricProjectionMatrix[1][1] = sqrt(6)/3;    IsometricProjectionMatrix[1][2] = 1/sqrt(6);		   IsometricProjectionMatrix[1][3] = 0;
	IsometricProjectionMatrix[2][0] = 1/sqrt(3);    IsometricProjectionMatrix[2][1] = (-1)/sqrt(3);   IsometricProjectionMatrix[2][2] = 1/sqrt(3);		   IsometricProjectionMatrix[2][3] = 0;
